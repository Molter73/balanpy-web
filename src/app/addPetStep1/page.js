...
export default function Home() {
  return (
    ...
    <main className="justify-items-center grid grid-cols-1 p-20 min-h-screen bg-gradient-to-b from-balanpy-500 from-20% via-balanpy-700 via-65% to-balanpy-900 to-100%">
      ...
      <section className="flex justify-center items-center mx-auto my-2 grid-cols-4 gap-40 bg-white rounded-full max-w-screen-md h-[3px]">
      ...
      <section className={`${styles.paddingX} ${styles.flexCenter}`}>
        <div
          className={`${styles.boxWidth} p-10 mx-auto rounded-2xl w-full bg-white`}
        >
          ...
          <div className="flex justify-center mt-8 gap-6 ">
            <ButtonSecondary styles={"text-[16px]"} text={"Cancelar"} href="" />
            <ButtonPrimary
              text={"Continuar"}
              href="/addPetStep2"
              styles={"text-[16px]"}
